            ...
            lines.forEach(function(one_line, index) {
              ...
              if (emit && line.length > 0) {
                ...
                try {
                  ...
                  throw new Error("Error parsing line " + line_count + " of file " + self.file.file_path + " \"" + line + "\": " + excp.message);
                }
                var completed_line_length  = Buffer.byteLength(line) + 2;
                var old_line_pos = line_pos;
                //console.log("READ returining: " + line + ', ' + old_line_pos + ', ' + completed_line_length);
                line = '';

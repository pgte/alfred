...
test: mkdirtmp
	...
	test_cached_key_map test_unordered_index test_unbuffered_collection test_flush_on_exit test_interleaved test_atomic test_compact test_nulls_on_key_map \
	test_nulls_on_indexes \
...
benchmark: mkdirtmp mkdirresults
	...
	benchmark_indexed_key_map_random benchmark_cached_key_map_random benchmark_unordered_index benchmark_cached_unordered_index benchmark_cached_ordered_index
# > benchmarks/results/runs/`date  "+%Y%m%d%H%M%S"`
